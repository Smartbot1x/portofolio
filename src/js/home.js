export default function Header() {
    ...
    setTimeout(() => {
        ...
        const updateLanguage = (lang) => {
            ...
            const aboutLink = document.querySelector('a[href="#"]:nth-of-type(1)');
            const contactLink = document.querySelector('a[href="#"]:nth-of-type(2)');
            const projectsLink = document.querySelector('a[href="../skill/index.html"]');

            // Ensure the elements exist before updating their text content
